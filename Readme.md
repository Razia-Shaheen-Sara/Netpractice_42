...
| Subnet Mask   | Block Size | IP Range                    | Network Address | Broadcast Address |
|---------------|------------|-----------------------------|-----------------|-------------------|
| 255.255.255.0 | /24        | 0 - 255                     | `x.x.x.0`       | `x.x.x.255`       |
| 255.255.255.128 | /25       | 0 - 127, 128 - 255           | `x.x.x.0`       | `x.x.x.127`       |
| 255.255.255.192 | /26       | 0 - 63, 64 - 127, 128 - 191, 192 - 255 | `x.x.x.0`       | `x.x.x.63`        |
| 255.255.255.224 | /27       | 0 - 31, 32 - 63, 64 - 95, 96 - 127, 128 - 159, 160 - 191, 192 - 223, 224 - 255 | `x.x.x.0` | `x.x.x.31` |
| 255.255.255.240 | /28       | 0 - 15, 16 - 31, 32 - 47, 48 - 63, 64 - 79, 80 - 95, 96 - 111, 112 - 127, 128 - 143, 144 - 159, 160 - 175, 176 - 191, 192 - 207, 208 - 223, 224 - 239, 240 - 255 | `x.x.x.0` | `x.x.x.15` |
| 255.255.255.252 | /30       | 0 - 3, 4 - 7, 8 - 11, ... 252 - 255 | `x.x.x.0` | `x.x.x.3` |
| 255.255.255.255 | /32       | Single IP                   | `x.x.x.x`       | `x.x.x.x`         |
